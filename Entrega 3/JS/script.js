...
class ConnectXGame {
    constructor(canvasId, options = {}) {
        ...
        // Establecer lineLength desde las opciones
        this.lineLength = options.lineLength || 4;
        
        // Calcular dimensiones del tablero basadas en lineLength
        const dimensions = this.calculateBoardDimensions(this.lineLength);
        
        // Actualizar tamaño del canvas basado en las dimensiones calculadas
        this.canvas.width = dimensions.cols * dimensions.cellSize;
        this.canvas.height = dimensions.rows * dimensions.cellSize;

        this.characters = {
            batman: {
                image: 'Imagenes/4-en-linea-game/batman.png',
                name: 'Batman'
            },
            nightwing: {
                image: 'Imagenes/4-en-linea-game/nightwing.png',
                name: 'Nightwing'
            },
            joker: {
                image: 'Imagenes/4-en-linea-game/joker.png',
                name: 'Joker'
            },
            harley: {
                image: 'Imagenes/4-en-linea-game/harley.png',
                name: 'Harley Quinn'
            }
        };
        ...
        // Update piece images based on selected characters
        this.images = {
            player1: new Image(),
            player2: new Image()
        };
...
function initializeGameUI() {
    // Inicializar selección de personajes
